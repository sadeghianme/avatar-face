...
const resources = {
  en: {
    translation: {
      ...
      photofaceHDSubtitle:
        "A separate depth-aware renderer built from your existing photo, face rig and speech timing. Your current avatars and pages stay unchanged.",
      ...
      shareOffBody:
        "Publish a page anyone with the link can open and type into. No account needed on their side.",
      shareOnBody:
  ...
  fr: {
    translation: {
      ...
      photofaceHDEmptyTitle: "Choisissez un avatar photo prêt",
      photofaceHDEmptyBody: "Créez d'abord un avatar photo, puis revenez ici pour le tester dans le moteur HD.",
      ...
      shareOffBody:
        "Publiez une page que toute personne disposant du lien peut ouvrir. Aucun compte requis de leur côté.",
      shareOnBody:
